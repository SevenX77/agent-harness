...
## 4. 设计决策基础(用户原话)
> callbacks 是什么(2026-06-03 PM):"callback是指所有返回的消息吗?" → 不是,是可观测事件流(34 类 event),不是 messages/RunResult。
...
## 8. gaps / 待设计
1. V4 trace 增补:微观拓扑事件(`parent_node_id`)、3 个边操作事件、Prompt 三视图、reducer 前后态 diff。
