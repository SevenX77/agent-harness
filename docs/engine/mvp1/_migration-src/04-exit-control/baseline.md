...
~~# 04-exit-control — Baseline(现状)~~ → ✅[已迁入](../../02-mechanism/05-run-inner/05-exit-control/baseline.md#后端功能)
...
~~## 覆盖范围~~ → ✅[已迁入](../../02-mechanism/05-run-inner/05-exit-control/baseline.md#后端功能)
...
~~## 编号执行流程(现状)~~ → ✅[已迁入](../../02-mechanism/05-run-inner/05-exit-control/baseline.md#后端功能)
...
~~## Baseline / Alignment 差异~~ → ✅[已迁入](../../02-mechanism/05-run-inner/05-exit-control/baseline.md#后端功能)
...
~~## 决策原因~~ → ✅[已迁入](../../02-mechanism/05-run-inner/05-exit-control/baseline.md#后端功能)
...
~~## 代码索引(clues)~~ → ✅[已迁入](../../02-mechanism/05-run-inner/05-exit-control/baseline.md#后端功能)
...
~~## 待办/疑点~~ → ✅[已迁入](../../02-mechanism/05-run-inner/05-exit-control/baseline.md#后端功能)
