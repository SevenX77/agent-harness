...
| T3-22 | **Settings「CLI」区(安装/鉴权/一键装/分角色配置)** | 提案已落盘(#610)待 PM 批 | `docs/design/2026-08-06-cli-settings-section-proposal.md`:与 Claude Agent SDK 并列 accordion;探测/安装归 Tauri、配置 truth 归 backend settings;四期交付。批准后写回 00_settings-ux-spec.md 再实施 |
