...
ERROR_REGISTRY: dict[str, ErrorCodeMetadata] = {
    ...
    '[F-v3-agent-llm-role-missing]': ErrorCodeMetadata('[F-v3-agent-llm-role-missing]', 'FATAL', ('编译期',), 'docs/engine/mvp1/01-contract/02-skill-syntax/mvp1-alignment.md#2-语法部件清单--mvp1-写入状态'),
...
_CATALOG_METADATA_ROWS: tuple[tuple[str, str], ...] = (
    ...
    (_DOMAIN_AGENT, '为该 phase 设置 llm_role，或在 GRAPH.md 设整图默认（子图需各自声明）'),
