...
io:
  ...
  outputs:
    ...
    properties:
      story_framework:
        type: object
phases: [global_analysis, retroactive, scene_assembly, export]
---
<phase depends_on="input">global_analysis</phase>
<phase depends_on="global_analysis">retroactive</phase>
<phase depends_on="retroactive">scene_assembly</phase>
<phase depends_on="scene_assembly" output>export</phase>
