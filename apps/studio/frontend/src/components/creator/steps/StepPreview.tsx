...
export function StepPreview({ data, preview, directoryPath }: StepPreviewProps) {
  return (
    <div className="flex h-full min-h-0 flex-col gap-3">
      <div>
        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">Preview SKILL.md</h2>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Creates <span className="font-mono">{directoryPath ?? `AgentStudio/Skills/${data.skillId}`}/SKILL.md</span>.
        </p>
      </div>
