...
---
<!-- 核对进度:已迁 0 块 / 未迁 9 块 / 2026-06-04 -->

<!-- ⚠️ 未迁入（正式 graph-exec/observability 仅摘要，缺子图 inputs 放宽、文件注入、artifact md 来源、三类边操作事件、FROZEN 解冻清单） → 应归入:02-mechanism/04-run-outer/01-graph-exec + 02-mechanism/06-seam/02-observability -->
