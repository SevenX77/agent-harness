...
class E2ETestMonitor:
    ...
    def add_error(self, chapter: int, error: str):
        """Add error record."""
        self.errors.append(
            {"chapter": chapter, "error": error, "timestamp": datetime.now().isoformat()}
        )
    ...
    def get_summary(self) -> dict:
        ...
        return {
            ...
            "avg_time_per_chapter": total_time / self.completed_chapters
    ...
    def print_summary(self):
        ...
        success_rate = (summary["completed_chapters"] / summary["total_chapters"]) * 100
...
class E2ETestRunner:
    ...
    def _run_segmentation(self, chapter_number: int, content: str) -> dict:
        ...
        result = run_skill(
            skill_path, inputs={"chapter_number": chapter_number, "chapter_content": content}
        )
    ...
    def run(self, input_path: Path, output_dir: Path) -> int:
        ...
        try:
            ...
            if success_count == self.EXPECTED_CHAPTERS:
                ...
                print(
                    "\n⚠ PARTIAL SUCCESS: "
                    f"{success_count}/{self.EXPECTED_CHAPTERS} chapters completed"
                )
                return 1
