...
UNCORRECTABLE_FIELDS = ["scene_space_type", "climax_intensity", "emotion_type"]
                ...
                corrections.append(
                    {
                        ...
                        "reason": (
                            f"Field {field} was inferred at {ev.get('event_id')}, "
                            f"but explicitly defined at {anchor_event_id}"
                        ),
                    }
                )
