...
class SDKPredictContext:
    ...
    def __init__(
        self,
        strategy: Any,
        copilot_predict: Callable[[str, str, list[Any]], Any] | None = None,
    ) -> None:
...
def predict_skill(  # noqa: C901
    ...
    *,
    ...
    copilot_predict: Callable | None = None,  # type: ignore[type-arg]
    **inputs: Any,
) -> RunResult:
    ...
    predict_context = SDKPredictContext(
        strategy,
        cast("Callable[[str, str, list[Any]], Any] | None", copilot_predict),
    )
...
def _write_workflow_result_artifacts(run_dir: Path, result: RunResult) -> None:
