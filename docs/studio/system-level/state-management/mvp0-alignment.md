...
The owner UI is [trace-visualization mvp0](../../feature-folders/trace-visualization/mvp0-alignment.md#cross-trace-edge-inspection).
...
Copilot owns the message schema in [copilot-assistance mvp0](../../feature-folders/copilot-assistance/mvp0-alignment.md#cross-copilot-mentions).
...
Canvas sets graph selections in [canvas-topology mvp0](../../feature-folders/canvas-topology/mvp0-alignment.md#cross-canvas-copilot-context).
Trace sets event/edge selections in [trace-visualization mvp0](../../feature-folders/trace-visualization/mvp0-alignment.md#cross-trace-edge-inspection).
...
Multi-file editor owns editor behavior in [multi-file-editor mvp0](../../feature-folders/multi-file-editor/mvp0-alignment.md#cross-editor-copilot-drafts).
