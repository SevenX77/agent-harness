...
| 块 | 形态 | 职责 |
|---|---|---|
| [`gateway/`](./gateway/mvp1-alignment.md) | Python sidecar | provider/role/credential/model 解析 + copilot chat LLM 流 |
| [`engine/`](./engine/mvp1-alignment.md) | Python sidecar | graph-agent: compile/lint/predict/run/eval/trace |
| [`native-fs/`](./native-fs/mvp1-alignment.md) | Rust(Tauri) | **唯一写者**: FS 读写/打开文件夹/watch/MRU/reveal + runs/golden/artifacts 目录 + 闭环编排 + sidecar 生命周期 + copilot session 落盘 |
| [`state-engine/`](./state-engine/mvp1-alignment.md) | 前端 | 前端状态 + WS / Rust-event ipc 桥 |
...
| 文档 | 职责 |
|---|---|
| [`gateway/`](./gateway/mvp1-alignment.md) | gateway 库/平台边界: provider/model/role/capability/route 解析、fallback、health/state projection。 |
| [`engine/`](./engine/mvp1-alignment.md) | graph-agent 引擎边界: compile/lint/predict/run/trace/golden/debug-resume 依赖。 |
| [`native-fs/`](./native-fs/mvp1-alignment.md) | Rust/Tauri 本地文件与 sidecar 生命周期边界。 |
| [`state-engine/`](./state-engine/mvp1-alignment.md) | 前端状态、WS、stage、trace/debug reducer 边界。 |
