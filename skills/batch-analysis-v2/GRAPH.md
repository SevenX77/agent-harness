...
name: batch-analysis-v2
description: Analyze a single batch (10 events) across 7 dimensions with entity registration and narrative continuity checking.
io:
  inputs:
    type: object
  ...
  outputs:
    ...
    properties:
      ...
      updated_accumulated:
        type: object
phases: [prepare, entity_and_characters, parallel_analysis, format_continuity, continuity, assemble]
---
...
<phase depends_on="parallel_analysis">format_continuity</phase>
