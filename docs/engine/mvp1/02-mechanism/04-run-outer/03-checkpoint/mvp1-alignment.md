...
doc: mvp1-alignment
status: drafted（A 成段 + records 深度回填 2026-06-05:递归拓扑 / delta-compact 正交 / durability / CK1-6 / D-test,**均已标注目标态 vs live**(codex 复审纠"目标当现状");live 仅外层 super-step checkpoint + WorkflowState.messages DeltaChannel;内层 ns/agent checkpoint/resume/compaction/data delta 全待实现）
