...
def _build_runtime_middlewares(
    *,
    ...
    include_sandbox: bool = True,  # MODIFIED: configurable sandbox
    lazy_init: bool = True,
    ...
    # MODIFIED: SandboxMiddleware is now configurable.
    # When tools don't need sandbox (e.g. custom tools with their own file I/O),
    # sandbox can be skipped to avoid virtual path mapping conflicts.
    if include_sandbox:
...
def build_lead_runtime_middlewares(*, lazy_init: bool = True, include_sandbox: bool = True) -> list[AgentMiddleware]:
...
def build_subagent_runtime_middlewares(*, lazy_init: bool = True, include_sandbox: bool = True) -> list[AgentMiddleware]:
