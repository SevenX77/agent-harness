...
| **U9** | **可观测事件流** | `overview §6` api 面 | 事件流切面(34 typed event)→`02-observability`◆ · 追踪中间件→`02-middleware`(Tracing 槽) · API 切面→`03-api-contract`(协议→trace.jsonl/WS) · 边操作事件→`graph-exec` | `callbacks/events.py` typed events + callbacks;内联 emit 待迁 Tracing 中间件 | drafted | 主 trace 事件已迁;但 `_migration-src/11-io-and-edge-ops` 的边操作事件/黑板切片/artifact 细节未迁入 `graph-exec`/`observability` |
...
2. **锁迁移序(真实版)**:
   - 先清 **B stub**:~~`01-contract/04-data-contracts/baseline.md`~~(✅ Phase 1)、~~`01-contract/05-invalidation/baseline.md`~~(✅ Phase 2,codex 复审)、`02-mechanism/05-run-inner/06-golden-eval/baseline.md`、`03-api-contract/baseline.md`。
...
| `02-mechanism/04-run-outer/01-graph-exec` | ✅ `mvp1-alignment.md:32,40-42`; overview `00-architecture-overview.md:113` | ✅ `baseline.md:6,22-41`; code `graph_assembler.py:325/363`, `state_mapper.py:37`, `actions.py:18/49` | ◐ `mvp1-alignment.md:55-64`; source `11-io-and-edge-ops/baseline.md:11-13` | LOGIC 决策已定;run_context/io_manager/nudge 与 11-io 黑板/artifact/edge 细节未迁全。 |
...
| `02-mechanism/04-run-outer/03-checkpoint` | ◐ `mvp1-alignment.md:25,32-35`; records `state-checkpoint-storage-model.md:15,25,98-105` | ◐ `baseline.md:4,20-27`; code `checkpointer.py:123`, `graph_assembler.py:151`, `state.py:214` | ◐ records `state-checkpoint-storage-model.md:25,57,77,82,95,107`; uncovered `uncovered-areas.md:76,93,98` | 正式文档仅摘要承载;递归拓扑、delta/compact、durability、CK/D-test/PM 原话未迁完。 |
...
| `02-mechanism/05-run-inner/06-golden-eval` | ✅ `mvp1-alignment.md:24,30-32`; overview `00-architecture-overview.md:93` | ❌ `baseline.md:10-14`; source `09-golden-eval/baseline.md:8-10` | ❌/◐ `mvp1-alignment.md:10`; source `09-golden-eval/mvp1-alignment.md:9,19` | baseline 0/6 未迁;alignment 1/12 未迁,旧 G1-G5 需退役或按 workspace 方案重写。 |
...
| `02-mechanism/05-run-inner/08-messages-state` | ◐ `mvp1-alignment.md:24,31-33`; records `state-checkpoint-storage-model.md:15,25,98-105` | ◐ `baseline.md:4,20-27,38,46`; code `state.py:214` | ◐ records `state-checkpoint-storage-model.md:25,57,77,82,95,107`; uncovered `uncovered-areas.md:76,98` | DeltaChannel live;compaction/resume 未接;records 的深度约束未迁完。 |
...
| `02-mechanism/06-seam/02-observability` | ✅ `mvp1-alignment.md:21,27-29` | ✅ `baseline.md:4,20-27`; code `events.py:56-443`, `emit.py:15`, `tracing.py:58` | ◐ source `11-io-and-edge-ops/baseline.md:11-13,31`; `11-io-and-edge-ops/mvp1-alignment.md:10-12,50` | trace 主体迁完;边操作事件族、artifact/compaction/黑板切片细节未迁全。 |
...
| `_migration-src/09-golden-eval/baseline.md` | 0/6 已迁 | `02-mechanism/05-run-inner/06-golden-eval/baseline.md` | `09-golden-eval/baseline.md:8,10,15,33,45,57,69` |
| `_migration-src/09-golden-eval/mvp1-alignment.md` | 1/13 已迁,12 块未迁 | `02-mechanism/05-run-inner/06-golden-eval/mvp1-alignment.md` | `09-golden-eval/mvp1-alignment.md:9,19,31,34,50,59,64,69,74,84,92,98,108` |
| `_migration-src/11-io-and-edge-ops/baseline.md` | 0/6 已迁 | `02-mechanism/04-run-outer/01-graph-exec` + `02-mechanism/06-seam/02-observability` | `11-io-and-edge-ops/baseline.md:11,13,18,34,44,55,65` |
| `_migration-src/11-io-and-edge-ops/mvp1-alignment.md` | 0/9 已迁 | `02-mechanism/04-run-outer/01-graph-exec` + `02-mechanism/06-seam/02-observability` | `11-io-and-edge-ops/mvp1-alignment.md:10,12,17,25,34,43,54,65,74,80` |
| `_migration-src/records/state-checkpoint-storage-model.md` | 7/14 已迁,7 块未迁 | `02-mechanism/04-run-outer/03-checkpoint` + `02-mechanism/05-run-inner/08-messages-state` | `state-checkpoint-storage-model.md:15,25,28,57,77,82,95,107` |
