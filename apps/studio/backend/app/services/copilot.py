...
_WRITE_TOOL_ACTION_LABELS = {
    ...
    "mcp__studio__write_golden_case": "Write Golden Case",
    "mcp__studio__delete_golden_baseline": "Delete Golden Baseline",
    "mcp__studio__resume_run": "Resume Run",
    "mcp__studio__pause_run": "Pause Run",
    "mcp__studio__stop_run": "Stop Run",
    "mcp__studio__publish_skill": "Publish Skill",
    "mcp__studio__fork_skill": "Fork Skill",
