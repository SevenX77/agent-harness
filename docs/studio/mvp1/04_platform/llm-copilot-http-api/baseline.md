...
> **现状一句话**: `routers/llm.py` 是巨型 router，HTTP glue 与 probe/materialize/draft/6态内核混在一起；Copilot SDK test 仍走假路径 ⚠️。
...
> **验"是否按目标改了"**：1. router 边界；2. Copilot SDK test；3. DTO SSOT。
