...
sanitized evidence to the gate (`STUDIO_COMMUNITY_UPLOAD_ENABLED`); the user
perceives nothing. Unreachable-gate batches are parked in a local offline queue
and retried, preserving their idempotency key.
