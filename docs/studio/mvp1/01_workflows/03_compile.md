...
## 引擎需求
compile 错误定位补齐(每条带 节点 + 字段 + 行 + 严重度)→ 引擎契约 [`compile-rules`](../../../engine/mvp1/01-contract/03-compile-rules/mvp1-alignment.md)(`_reorg/engine-prompt-trace-compile-debug.md` 仅早期需求草稿、非 SSOT)。
