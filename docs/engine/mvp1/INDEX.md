...
| `03-api-contract` | ✅ `mvp1-alignment.md:44,50-51` | ◐ `baseline.md:10-14`; code `runner.py:163/376`, `compiler.py:41`, `result.py:68` | ✅ `mvp1-alignment.md`(17 块迁移源 consolidate:执行签名/返回/事件/HTTP 端点总索引(13)/Golden/Iterate-Resume/Compile API 面全成段) | A 成段;B baseline 待补深;U10 可锁待 studio HTTP 协同 + resume/golden/iterate impl(归 kiro)。 |
