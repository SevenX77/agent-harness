...
| [`v1-era/`](./v1-era/) | 早期 V1 时代写的 engine doc, V2.1 cutover 后核心概念 (`GraphAgentHarness` / `script/validators.py` 单文件结构) 已不存在: IMPLEMENTATION / USER_GUIDE / INTEGRATION_GUIDE / COGNITIVE_LOOP_GUIDE / FRAMEWORK_UNDERSTANDING | 2026-04 ~ 2026-05 V1 → V2.1 transition 前 |
