...
- **Sources**: public-api, source-file-map
- **Core paths**: packages/graph-agent/src/graph_agent/core/graph_assembler.py, packages/graph-agent/src/graph_agent/core/loader.py, packages/graph-agent/src/graph_agent/core/manifest.py
- **Primary contracts**: 2 error codes, 0 events
- `[Covered By: packages/graph-agent/tests/core/test_ws_e1_iterate_runtime_contract_red.py::test_loop_iterate_requires_item_and_accumulator_in_phase_inputs]`
...
- `[Covered By: packages/graph-agent/tests/core/test_round14_skill_compilation_cutover.py::test_subgraph_io_input_mismatch_is_allowed_at_compile_time]`
