...
LLM provider config owns provider UI in [llm-provider-config mvp0](../../feature-folders/llm-provider-config/mvp0-alignment.md#cross-llm-secure-storage).
...
LLM provider config owns provider UI and role resolution, see [llm-provider-config mvp0](../../feature-folders/llm-provider-config/mvp0-alignment.md#cross-llm-secure-storage).
