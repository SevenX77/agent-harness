...
io:
  inputs:
    type: object
    required: [batch_events_text, accumulated_context_text, batch_chapter_range, dynamic_dimensions_hint, accumulator_state]
    properties:
      batch_events_text:
        type: string
  ...
  outputs:
    type: object
    required: [entity_registry, entity_aliases, character_results]
    properties:
      entity_registry:
        type: object
      entity_aliases:
